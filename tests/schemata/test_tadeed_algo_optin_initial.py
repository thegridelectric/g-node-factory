"""Tests tadeed.algo.optin.initial type, version 000"""
import json
...
from gnf.schemata import TadeedAlgoOptinInitial_Maker as Maker


def test_tadeed_algo_optin_initial_generated():
    ...
    d = {
        ...
        "TypeName": "tadeed.algo.optin.initial",
        "Version": "000",
    }

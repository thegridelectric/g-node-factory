...
from gnf.schemata import InitialTadeedAlgoOptin_Maker as Maker


def test_initial_tadeed_algo_optin_generated():

    d = {
        "TerminalAssetAlias": "dw1.isone.ver.keene.holly.ta",
